     ...
     public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource()==checkprice){
           ...
           if(persons * days >0){
            ...
            try{
               Conn c = new Conn();
               c.s.executeUpdate("insert into bookhotel values('"+labelusername.getText()+"','"+chotel.getSelectedItem()+"','"+tfpersons.getText()+"','"+cac.getSelectedItem()+"','"+tfdays.getText()+"','"+cfood.getSelectedItem()+"','"+labelid.getText()+"','"+labelnumber.getText()+"','"+labelphone.getText()+"','"+labelprice.getText()+"')");
