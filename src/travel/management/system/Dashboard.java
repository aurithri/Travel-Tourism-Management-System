...
public class Dashboard extends JFrame implements ActionListener {
    ...
    JButton viewpackage,viewhotels,destinations,bookhotel,viewbookedhotel, payments,calculator,notepad;
    JButton about;
    Dashboard(String username){
        ...
        JButton deletePersonalDetails = new JButton("Delete Details");
         ...
         deletePersonalDetails.setMargin(new Insets(0,0,0,115));
...
p2.add(viewpackage);
    ...
    if(ae.getSource() == addPersonalDetails){
       ...
       try{
        ...
        new About(); 
    }else if(ae.getActionCommand().equals("Delete Details")){
